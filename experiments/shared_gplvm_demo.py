...
>>>>>>> c0280532bebcb054486a8c1b0d6e1e595e1373f5
    ...
    loss_list = []
<<<<<<< HEAD
    iterator = trange(9000, leave=True)
    batch_size = 50
=======
...
<<<<<<< HEAD
    ...
    Y_train_recon, Y_train_pred_covar = shared_model.model_labels.reconstruct_y(torch.Tensor(Z_train)[0:500], Y_train, ae=False)
...
<<<<<<< HEAD
    ...
    diags_Y = torch.cat(diags_Y_list).reshape(500,3)
...
>>>>>>> c0280532bebcb054486a8c1b0d6e1e595e1373f5
    ...
    if TEST:
        ...
        X_test = XY_test[::,0:-3][0:1000]
        Y_test = XY_test[:,-3::][0:1000]
...
<<<<<<< HEAD
        ...
        test_loss, test_model, Z_test = predict_joint_latent(test_model, X_test, None, likelihood_spectra, likelihood_labels, lr=0.001, prior_z = None, steps = 100)

        X_test_recon, X_test_pred_covar = test_model.model_spectra.reconstruct_y(Z_test.Z[0:200], X_test[0:200], ae=False)
...
<<<<<<< HEAD
        ...
        diags_Y = torch.cat(diags_Y_list).reshape(len(Y_test),3)
...
<<<<<<< HEAD
    ...
    plot_y_label_comparison(Y_train_recon_orig, Y_train_orig, Y_train_pred_sigma, \
                            col_id = 0, title=lumin_title,  colors=Y_train_orig[:,0].cpu().detach(), 
                            clabel=None,
                            xlabel = xlabel_lumin, \
                            ylabel = ylabel_lumin, \
                            cmap= 'spring')
    ...
    plot_y_label_comparison(Y_train_recon_orig, Y_train_orig, Y_train_pred_sigma, \
                            col_id = 1, title=bhm_title,  colors=Y_train_orig[:,1].cpu().detach(), 
                            clabel=None,
                            xlabel = xlabel_bhm, \
                            ylabel = ylabel_bhm, \
                            cmap= 'jet')
    ...
    plot_y_label_comparison(Y_train_recon_orig, Y_train_orig, Y_train_pred_sigma, \
                            col_id = 2, title=edd_title,  colors=Y_train_orig[:,2].cpu().detach(), 
                            clabel=None,
                            xlabel = xlabel_edd, \
                            ylabel = ylabel_edd, \
                            cmap= 'summer')    
